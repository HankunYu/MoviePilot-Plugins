...
class TorrentRemover_V2(_PluginBase):
    ...
    # 插件配置项ID前缀
    plugin_config_prefix = "torrentremover_v2_"
    # 加载顺序
    plugin_order = 8
    # 可使用的用户级别
    auth_level = 2
    ...
    def get_remove_torrents(self, downloader: str):
        ...
        if self._mponly:
            ...
            logger.info(f"自动删种任务 仅处理MoviePilot任务, tag为：{tags}")
        # 查询种子
