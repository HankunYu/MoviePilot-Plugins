...
from app.plugins.bangumi.bangumi_db import BangumiInfo
from app.plugins.bangumi.bangumi_db_oper import BangumiOper
...
class Bangumi(_PluginBase):
    ...
    def name_season_convert(self, name : str) -> str:
        ...
        if match:
            ...
            if season_number >= 2 and season_number <= 10:
                chinese_number = ["一", "二", "三", "四", "五", "六", "七", "八", "九", "十"]
                try:
